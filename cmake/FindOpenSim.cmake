...
elseif(OPENSIM_HOME)
    ...
    # Mac, Linux, Cygwin.
    if(UNIX)
        list(APPEND OPENSIM_SEARCH_PATHS $ENV{HOME}/.local)
        list(APPEND OPENSIM_SEARCH_PATHS $ENV{NEUROROBOTICS_MODULE_PATH}/opensim/$ENV{OPENSIM_BUILD_VERSION}/rhel6/$ENV{BUILD_COMPILER}/$ENV{BUILD_ARCHITECTURE})

        # Unlikely (for when OpenSim is distributed through distro package
        # managers):
        list(APPEND OPENSIM_SEARCH_PATHS /usr)
        list(APPEND OPENSIM_SEARCH_PATHS $ENV{HBP}/opensim/OpenSim33-source)
    endif()
...
if(OPENSIM_FOUND)
    ...
    message(STATUS "OpenSim Libraries found: ${OPENSIM_LIBRARIES}")
endif()
